...
// import superman from '../../assets/images/superman_logo.png';
...
export function coreMembersReducer(state = initialState, action: CoreMembersActions.CoreMembersActions) {
    if (!state) {
